namespace StorageBenchmark.Migrations.PostgreSQLDBContext
{
    ...
    internal sealed class ConfigurationPostgreSQLDBContext : DbMigrationsConfiguration<StorageBenchmark.Access.PostgreSQLDBContext>
    {
        private RDFFileHandler handler = new RDFFileHandler();
        private StorageBenchmark.Access.PostgreSQLDBContext dbContext = new Access.PostgreSQLDBContext();

        public ConfigurationPostgreSQLDBContext()
        {
            AutomaticMigrationsEnabled = false;
            MigrationsDirectory = @"Migrations\PostgreSQLDBContext";
        }

        protected override void Seed(StorageBenchmark.Access.PostgreSQLDBContext context)
        {
